...
```json
{
  ...
  "systems": [
    {
      ...
      "priority": "P0/P1/P2",
      "complexity": "S/M/L",
      "suggested_script": "PascalCase.ts",
      "suggested_module_type": "Class/Module/Scene"
    }
  ],
  "entities": {
    "实体类型": [
  ...
  "global_singleton": {
    "class_name": "GameData",
    "script_path": "src/core/GameData.ts",
    "export_name": "GameData",
...
schema = {
  ...
  'properties': {
    ...
    'global_singleton': {
      'type': 'object',
      'required': ['class_name', 'script_path', 'export_name', 'key_variables'],
      'properties': {
